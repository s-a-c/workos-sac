...
flowchart TD
    ...
    D --> H[Phase 0.8: API Documentation]
...
| --- | --- | --- | --- |
| 3.0.0 | 2025-05-25 | Restructured documentation with new organization and naming conventions, fixed duplicate flowchart entries | AI Assistant |
